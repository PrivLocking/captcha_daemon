...
togethere with a 32 bytes(in HEX ASCII) session id in cookie.
...
## /captcha_check
When the user/client want to visit protected area, use this to to verify the session id and auth id.
...
## for more details :
[Blog](https://blog00.jjj123.com/post/2025/04/20250406_210240/)
